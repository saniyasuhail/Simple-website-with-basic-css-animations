    ...
    <div class="container">
      ...
      if (isset($_GET['error'])) {
           ...
           if ($_GET["error"]=="nouser") {
               echo '<p class="signuperror">"Sorry, we can not find your profile, please Register yourself <a href="register.php> </a> here."</p>';
            }
            elseif ($_GET["error"]=="wrongpwd") {
               echo '<p class="signuperror">Invalid Username/Password</p>';
            }
            elseif ($_GET["error"]=="notsignedin") {
              echo '<p class="signuperror">Please Sign In to continue.</p>';
           }
            } 
